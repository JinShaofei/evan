...
<html>
<head>
<title>Shade Bootstarp Website Template | Men :: w3layouts</title>
	...
	<div class="content">
		...
		<div class="coats">
			...
			<div class="coat-row">
				<div class="coat-column">
					...
					<div class="mask">
		                       		<div class="info"><a href="single.html">View</a></div>
				      </div>
				</div>
				<div class="coat-column">
		...
		<div class="coats">
			...
			<div class="coat-row">
				...
				<div class="coat-column">
					<a href="single.html"><img src="images/p17.jpg" class="img-responsive" alt="">
						<div class="prod-desc"><h4>Double-Layered Top</h4><small>&euro; 89,95</small></div>
					</a>
					<div class="mask">
		                       		<div class="info"><a href="single.html">View</a></div>
				...
				<div class="coat-column">
					<a href="single.html"><img src="images/p18.jpg" class="img-responsive" alt="">
						<div class="prod-desc"><h4>Double-Layered Top</h4><small>&euro; 89,95</small></div>
					</a>
					<div class="mask">
		                       		<div class="info"><a href="single.html">View</a></div>
				...
				<div class="coat-column1">
					<a href="single.html"><img src="images/p19.jpg" class="img-responsive" alt="">
						<div class="prod-desc"><h4>Double-Layered Top</h4><small>&euro; 89,95</small></div>
					</a>
					<div class="mask">
		                       		<div class="info"><a href="single.html">View</a></div>
