...
<body>
	...
	<div class="container">
		...
		<div class="content">
			...
			<div class="coats">
				<h3 class="c-head">Cats</h3>
				<small><a href="#">查看更多</a></small>
				<div class="coat-row">
					<div class="coat-column">
						<a href="single.html"> <img src="images/p8.jpg"
					...
					<div class="coat-column">
						<a href="single.html"><img src="images/p9.jpg"
							class="img-responsive" alt="">
							<div class="prod-desc">
								<h4>Double-Layered Top</h4>
								<small>&euro; 89,95</small>
					...
					<div class="coat-column">
						<a href="single.html"><img src="images/p10.jpg"
							class="img-responsive" alt="">
							<div class="prod-desc">
								<h4>Double-Layered Top</h4>
								<small>&euro; 89,95</small>
					...
					<div class="coat-column1">
						<a href="single.html"><img src="images/p11.jpg"
							class="img-responsive" alt="">
							<div class="prod-desc">
								<h4>Double-Layered Top</h4>
								<small>&euro; 89,95</small>
			...
			<div class="coats">
				...
				<div class="coat-row">
					<div class="coat-column">
						<a href="single.html"> <img src="images/p12.jpg"
							class="img-responsive" alt="">
							<div class="prod-desc">
								<h4>Double-Layered Top</h4>
								<small>&euro; 89,95</small>
					...
					<div class="coat-column">
						<a href="single.html"><img src="images/p13.jpg"
							class="img-responsive" alt="">
							<div class="prod-desc">
								<h4>Double-Layered Top</h4>
								<small>&euro; 89,95</small>
					...
					<div class="coat-column">
						<a href="single.html"><img src="images/p14.jpg"
							class="img-responsive" alt="">
							<div class="prod-desc">
								<h4>Double-Layered Top</h4>
								<small>&euro; 89,95</small>
					...
					<div class="coat-column1">
						<a href="single.html"><img src="images/p15.jpg"
							class="img-responsive" alt="">
							<div class="prod-desc">
								<h4>Double-Layered Top</h4>
								<small>&euro; 89,95</small>
